...
export class HistorialMedicoService {
  ...
  static async create(body: any) {
    return await sql`
      INSERT INTO historial_medico (animal_id, veterinario_id, tipo_consulta_id, fecha_consulta, observaciones)
      VALUES (${body.animal_id}, ${body.veterinario_id}, ${body.tipo_consulta_id}, ${body.fecha_consulta}, ${body.observaciones})
      RETURNING *
    `;
  }
  static async findById(id: string) {
    return await sql`
      ...
      LEFT JOIN usuarios u ON v.usuario_id = u.usuario_id
      LEFT JOIN tipo_consulta tc ON h.tipo_consulta_id = tc.tipo_consulta_id
      WHERE h.historial_medico_id = ${id}
    `;
  }
}
